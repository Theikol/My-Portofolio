...
{ nama: "Vercel ",               ikon: "fa-solid fa-square-caret-up",     warna: "clr-git"   },
]);
        ...
        <div class="hero-photo reveal" style="--delay:.3s">
          <div class="photo-frame">
            ...
            <div v-else class="photo-placeholder">
              ...
              <code class="photo-code">profil.foto = '/assets/myprofil.jpeg'</code>
            </div>
